...
def retrieve_config[ConfigType: BaseModel](name: str, config_type: type[ConfigType]) -> ConfigType:
    raw_config_content: dict = yaml.safe_load(Path(f'config/{name}.yaml').read_text())
