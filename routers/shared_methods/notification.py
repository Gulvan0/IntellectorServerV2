...
from models.challenge import ChallengePublic
from models.config import IntegrationParams
from models.game import GamePublic
from models.notification import GameStartedNotification, NewPublicChallengeNotification, NotificationApp
from routers.shared_methods.player import prettify_player_reference
...
def send_new_public_challenge_notifications(caller: UserReference, public_challenge: ChallengePublic, integrations_config: IntegrationParams, session: Session) -> None:
    pretty_caller_ref = prettify_player_reference(caller, session)
...
def send_game_started_notifications(white_player_ref: str, black_player_ref: str, public_game: GamePublic, integrations_config: IntegrationParams, session: Session) -> None:
    ...
    pretty_white_ref = prettify_player_reference(white_player, session)
    pretty_black_ref = prettify_player_reference(black_player, session)
