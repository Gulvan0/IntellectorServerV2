...
from ..column_types import CurrentDatetime, OptionalSip, PlayerRef, OptionalPlayerRef
from utils.datatypes import TimeControlKind


if TYPE_CHECKING:
    from .time_control import GameFischerTimeControl, GameFischerTimeControlPublic
    from .outcome import GameOutcome, GameOutcomePublic
    from .ply import GamePlyEvent, GamePlyEventPublic
    from .chat import GameChatMessageEvent, GameChatMessageEventPublic
    from .offer import GameOfferEvent, GameOfferEventPublic
    from .rollback import GameRollbackEvent, GameRollbackEventPublic
    from .time_added import GameTimeAddedEvent, GameTimeAddedEventPublic
    from .time_update import GameTimeUpdatePublic
